...
Delart is an equal opportunity employer. We celebrate diversity and are dedicated to fostering an inclusive workplace for all employees. We strictly prohibit discrimination or harassment of any kind based on race, color, religion, age, sex, national origin, disability, genetics, veteran status, sexual orientation, gender identity, or any other characteristic protected by law.`,
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-zinc-900 via-gray-900 to-slate-800">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="firstName"
                  className="bg-white/20 border-green-900 text-white pl-10"
                  placeholder="John"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                <AtSign className="absolute left-3 top-3 h-4 w-4 text-gray-300" />
                <Input
                  id="email"
                  type="email"
                  className="bg-white/20 border-green-900 text-white pl-10"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              >
                <SelectTrigger className="bg-white/20 border-green-900 text-white">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Briefcase className="absolute left-3 top-3 h-4 w-4 text-gray-300" />
                <Input
                  id="experience"
                  type="number"
                  className="bg-white/20 border-green-900 text-white pl-10"
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-center w-full">
              <label
                htmlFor="resume"
                className="flex flex-col items-center justify-center w-full h-32 border-2 border-green-900 
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="coverLetter"
              className="bg-white/5 border-green-900 text-white min-h-[150px]"
          ...
          {/* Portfolio/LinkedIn */}
              ...
              <div className="space-y-4">
              {/* Error Messages */}
                {/* Update form fields to show error messages */}
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                {validationErrors.dateOfBirth && <p className="text-red-500 text-sm mt-1">Date of birth is required</p>}
                </div>
                <div className="space-y-2">
                {validationErrors.education && <p className="text-red-500 text-sm mt-1">Education level is required</p>}
                </div>
                <div className="space-y-2">
                {validationErrors.experience && <p className="text-red-500 text-sm mt-1">Years of experience is required</p>}
                </div>
                <div className="space-y-2">
                {validationErrors.resume && <p className="text-red-500 text-sm mt-1">Resume is required</p>}
                </div>
                <div className="space-y-2">
                {validationErrors.coverLetter && <p className="text-red-500 text-sm mt-1">Cover letter is required</p>}
                </div>
